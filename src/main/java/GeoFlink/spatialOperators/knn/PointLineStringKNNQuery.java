...
public class PointLineStringKNNQuery extends KNNQuery<Point, LineString> {
    public PointLineStringKNNQuery(QueryConfiguration conf, SpatialIndex index) {
        super.initializeKNNQuery(conf, index);
    }

    public DataStream<Tuple3<Long, Long, PriorityQueue<Tuple2<Point, Double>>>> run(DataStream<Point> pointStream, LineString queryLineString, double queryRadius, Integer k) throws IOException {
